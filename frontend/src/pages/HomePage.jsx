        ...
        <div className="flex-1 grid place-items-center p-6 text-center">
            <div className="max-w-xl">
                ...
                {isAuthenticated ? (
                    ...
                    >
                        <Button className="px-8 py-3 bg-primary text-white rounded-full text-lg font-semibold hover:bg-primary focus:outline-none focus:ring-4 focus:ring-purple-600 transition inline-flex items-center gap-2">
                    ...
                    <Dialog.Root open={open} onOpenChange={setOpen}>
                        <Dialog.Trigger asChild>
                            <Button className="inline-flex items-center justify-center px-8 py-3 bg-primary text-white rounded-full text-lg font-semibold hover:bg-primary focus:outline-none focus:ring-4 focus:ring-purple-600 transition">
                                Entrar
                            </Button>
                        </Dialog.Trigger>
